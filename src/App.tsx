...
function App() {
  ...
  return (
    <main>
      <div className="h-[50px] bg-[#3178c6] flex items-center pl-5">
        <div className="flex items-center gap-2">
          <TsLogo />
          <span className="text-[24px] text-white">TypeScript</span>
        </div>
      </div>
      ...
      <section className="h-[calc(100vh-100px)] bg-[#444] flex">
        ...
        >
          <Editor
            ...
            theme="vs-dark"
            loading={<div className="h-full w-full bg-[#1e1e1e]"></div>}
          />
        </div>
